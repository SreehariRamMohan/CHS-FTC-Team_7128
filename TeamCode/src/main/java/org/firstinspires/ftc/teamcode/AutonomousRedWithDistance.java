...
/**
 * Created by ShruthiJaganathan on 1/31/17.
 */
@Autonomous(name= "Autonomous With Distance Sensor", group = "Autonomous")
public class AutonomousRedWithDistance extends LinearOpMode{
    /*
    This code drives forward, shoots one particle, and hits one beacon. This is
    assuming the distance sensor is on the front of the robot.
     */
